"""Morph Panel - Self-editing interface for claude-code-morph."""
...
class MorphPanel(BasePanel):
    """Panel for self-editing claude-code-morph source code."""
    ...
    MorphPanel .editor-container {
        width: 70%;
        height: 100%;
        padding: 1;
    }
    
    MorphPanel .editor-header {
        height: 3;
        background: $boost;
        padding: 0 1;
        margin-bottom: 1;
    ...
    def __init__(self, **kwargs):
        ...
        self.source_root = Path.cwd()  # claude-code-morph directory
    ...
    def compose(self) -> ComposeResult:
        ...
        with Horizontal():
            ...
            with VerticalScroll(classes="file-browser"):
                ...
                yield Tree("claude-code-morph", id="file-tree")
    ...
    async def _ask_claude_about_code(self) -> None:
        ...
        prompt = f"I'm looking at the file {relative_path} in the claude-code-morph project. Here's the current code:\n\n```python\n{code}\n```\n\nPlease help me understand or improve this code."
